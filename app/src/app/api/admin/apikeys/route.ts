...
const ALLOWED = ['virustotal', 'shodan', 'hibp', 'urlscan', 'gemini', 'abusech', 'aisstream']
...
export async function PUT(req: NextRequest) {
  ...
  const parsed = z.object({ service: z.enum(['virustotal', 'shodan', 'hibp', 'urlscan', 'gemini', 'abusech', 'aisstream']), key: z.string().min(1) }).safeParse(body)
